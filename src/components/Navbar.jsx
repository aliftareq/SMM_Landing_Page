    ...
    <>
      <nav className="w-full flex justify-center pt-8">
        ...
        >
          {/* Logo */}
          <a href="#home">
            <h1 className="text-[24px] font-bold text-black">SMM Panel</h1>
          </a>

          {/* Desktop Navigation */}
          <div className="hidden lg:flex items-center gap-8">
            <a href="#home" className="text-[16px] font-bold text-[#F47B20]">
              Home
            </a>
            <a href="#services" className="text-[16px] font-bold text-black">
              Service
            </a>
            <a href="#about" className="text-[16px] font-bold text-black">
              About
            </a>
            <a href="#api" className="text-[16px] font-bold text-black">
              API
            </a>
            <a href="#contact" className="text-[16px] font-bold text-black">
              Contact
            </a>
          </div>
      ...
      >
        ...
        <div className="flex flex-col gap-6 mt-10">
          <a href="#home" className="text-[#F47B20] font-bold">
            Home
          </a>
          ...
          <a href="#api" className="font-bold">
            API
          </a>
